...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabsJsx = __webpack_require__(157);

	var _tabsJsx2 = _interopRequireDefault(_tabsJsx);

	var _searchJsx = __webpack_require__(158);

	var _searchJsx2 = _interopRequireDefault(_searchJsx);

	var _savedJsx = __webpack_require__(163);

	var _savedJsx2 = _interopRequireDefault(_savedJsx);
	    ...
	    _createClass(Main, [{
	        ...
	        value: function render() {
	            ...
	            if (this.state.currentId === 'search') {
	                currentTab = _react2['default'].createElement(_searchJsx2['default'], null);
	            } else if (this.state.currentId === 'saved') {
	                currentTab = _react2['default'].createElement(_savedJsx2['default'], null);
	            }

	            return _react2['default'].createElement(
	                'main',
	                { className: 'main' },
	                _react2['default'].createElement(_tabsJsx2['default'], { tabs: tabs, onChangeTab: this.changeTab.bind(this), currentId: this.state.currentId }),
	                currentTab
	            );
	        }
	    }]);
	...
	_react2['default'].render(_react2['default'].createElement(Main, null), document.getElementById('container'));
	...
	var Tabs = (function (_React$Component) {
	    ...
	    _createClass(Tabs, [{
	        ...
	        value: function renderTab(tab) {
	            ...
	            return _react2['default'].createElement(
	                'li',
	                { onClick: this.handleClick.bind(this), className: className, key: tab.id, 'data-id': tab.id },
	                tab.name
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _finderJsx = __webpack_require__(159);

	var _finderJsx2 = _interopRequireDefault(_finderJsx);

	var _postcodeListJsx = __webpack_require__(161);

	var _postcodeListJsx2 = _interopRequireDefault(_postcodeListJsx);
	    ...
	    _createClass(Search, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(_finderJsx2['default'], { onGetData: this.handleNewData.bind(this) }),
	                _react2['default'].createElement(_postcodeListJsx2['default'], { data: this.state.data })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsJs = __webpack_require__(160);
	...
	var Finder = (function (_React$Component) {
	    ...
	    _createClass(Finder, [{
	        ...
	        value: function componentWillMount() {
	            this.getData = _utilsJs2['default'].debounce(this.getData, 200, true);
	        }
	    }, {
	        key: 'getData',
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                { className: 'finder' },
	                _react2['default'].createElement('input', { ref: 'text', onChange: this.handleChange.bind(this), className: 'finder__text', type: 'text', placeholder: 'Введите адрес' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postcodeItemJsx = __webpack_require__(162);

	var _postcodeItemJsx2 = _interopRequireDefault(_postcodeItemJsx);

	var PostcodeList = (function (_React$Component) {
	    function PostcodeList(props) {
	        _classCallCheck(this, PostcodeList);

	        _get(Object.getPrototypeOf(PostcodeList.prototype), 'constructor', this).call(this, props);
	    }

	    _inherits(PostcodeList, _React$Component);

	    _createClass(PostcodeList, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'ul',
	                    { className: 'postcodeList__list' },
	                    postcodeItems.map(function (item) {
	                        return _react2['default'].createElement(_postcodeItemJsx2['default'], { item: item, key: item.id });
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostcodeItem = (function (_React$Component) {
	    function PostcodeItem(props) {
	        _classCallCheck(this, PostcodeItem);

	        _get(Object.getPrototypeOf(PostcodeItem.prototype), 'constructor', this).call(this, props);
	        this.state = { saved: props.item.saved };
	    }

	    _inherits(PostcodeItem, _React$Component);

	    _createClass(PostcodeItem, [{
	        key: 'handleSaveClick',
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                'li',
	                { className: 'postcodeList__item' },
	                _react2['default'].createElement(
	                    'span',
	                    { className: className, onClick: this.handleSaveClick.bind(this) },
	                    '♡'
	                ),
	                _react2['default'].createElement(
	                    'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Saved = (function (_React$Component) {
	    function Saved(props) {
	        ...
	        _get(Object.getPrototypeOf(Saved.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(Saved, [{
	        key: 'render',
	        value: function render() {
	            return _react2['default'].createElement(_postcodeListJsx2['default'], { data: this.state.data, title: 'Избранное' });
	        }
	    }]);
