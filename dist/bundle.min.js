	...
	var Search = (function (_React$Component) {
	    ...
	    _createClass(Search, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                { className: 'search + ' + (this.props.active ? ' search_active' : '') + ' ' },
	                _react2['default'].createElement(
	                    'h2',
	                    null,
	                    'Поиск'
	                ),
	                _react2['default'].createElement(_finderJsx2['default'], { store: this.props.store }),
	                _react2['default'].createElement(_postcodeListJsx2['default'], { store: this.props.store, list: 'searchedList', title: 'Результаты поиска' })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostcodeList = (function (_React$Component) {
	    ...
	    function PostcodeList() {
	        ...
	        _get(Object.getPrototypeOf(PostcodeList.prototype), 'constructor', this).apply(this, arguments);
	    }
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    this.props.store.getState()[this.props.list].map(function (item) {
	                        return _react2['default'].createElement(_postcodeItemJsx2['default'], { item: item, key: item.id, store: _this.props.store });
	                    })
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Saved = (function (_React$Component) {
	    ...
	    function Saved() {
	        ...
	        _get(Object.getPrototypeOf(Saved.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(Saved, [{
	        ...
	        value: function render() {
	            return _react2['default'].createElement(
	                'div',
	                { className: 'saved + ' + (this.props.active ? ' saved_active' : '') + ' ' },
	                _react2['default'].createElement(_postcodeListJsx2['default'], { store: this.props.store, list: 'savedList', title: 'Избранное' })
	            );
	        }
	    }]);
